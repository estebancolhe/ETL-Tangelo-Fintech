...
#Al momento de medir el tiempo cuando crea cada fila del dataframe, se demora el mismo tiempo
#es por eso que el timpo en cada fila es el mismo, pero las funciones de maximo, minimo,
#promedio y total funcionan sin problema
